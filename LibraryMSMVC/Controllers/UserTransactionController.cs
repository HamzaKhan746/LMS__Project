...
namespace LibraryMSMVC.Controllers
{
    public class UserTransactionController : Controller
    {
        ...
        LibraryMSWAEntities2 context = new LibraryMSWAEntities2();
        ...
        public ActionResult Requested(int? userId)
        {
            ...
            tblUser user = context.tblUsers.Find(userId);
            if (user == null)
            {
                return HttpNotFound();
            }
            UserTransactionController.userId = (int)userId;
            var requestList = context.tblTransactions.Where(s => s.TranStatus == "Requested" && s.UserId == userId);
        ...
        public ActionResult Rejected(int? userId)
        {
            ...
            UserTransactionController.userId = (int)userId;
            var rejectedList = context.tblTransactions.Where(s => s.TranStatus == "Rejected" && s.UserId == userId);
        ...
        public ActionResult Received(int? userId)
        {
            ...
            UserTransactionController.userId = (int)userId;
            var receivedList = context.tblTransactions.Where(s => s.TranStatus == "Accepted" && s.UserId == userId);
