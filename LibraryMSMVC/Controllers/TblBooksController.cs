...
namespace LibraryMSMVC.Controllers
{
    public class TblBooksController : Controller
    {
        ...
        {
            var booklist = context.tblBooks.ToList();
        ...
        public ActionResult Details(int? id)
        {
            ...
            tblBook tblBook = context.tblBooks.Find(id);
            if (tblBook == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Edit([Bind(Include = "BookId,BookTitle,BookCategory,BookAuthor,BookCopies,BookPub,BookPubName,BookISBN,Copyright,DateAdded,Status")] tblBook tblBook)
        {
            if (ModelState.IsValid)
            {
                ...
                context.Entry(tblBook).State = EntityState.Modified;
                context.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(tblBook);
        ...
        {
            tblBook tblBook = context.tblBooks.Find(id);
            context.tblBooks.Remove(tblBook);
            context.SaveChanges();
            return RedirectToAction("Index");
        }
